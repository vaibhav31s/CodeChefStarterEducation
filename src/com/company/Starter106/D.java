package com.company.Starter106;
...
//            int[] arr = readarr(sc, n);
            ...
            long reduce = (long) x * m;
            long reduce1 = (long) x * n;
            long reduce2 = (long) y * m;
            long reduce3 = (long) y * n;

            long reduce4 = (long) y * x;

            long min = Math.min(reduce1, Math.min(reduce2, Math.min(reduce3, reduce4)));


            out.println(answer- min-1);
