package com.company.Starter109;
    ...
    public static void main(String[] args) {
        ...
        while (t-- > 0) {
            ...
            for(int i = n - 1; i >= 0 ; i -= 2) {
                KeyValue<Long, Long> xy = getXY(arr[i - 1], arr[i]);

                if(xy.getKey() == Long.MIN_VALUE && xy.getValue() == Long.MIN_VALUE){
                    out.println(-1);
                    continue outer;
                }
                list1.add(xy.getValue());
                list2.add(xy.getKey());
            }
//            out.println(list1);
//            out.println(list2);
    ...
    public static KeyValue<Long, Long>  getXY(int a, int b) {
        ...
        return new KeyValue<Long,Long>(Long.MIN_VALUE, Long.MIN_VALUE);
    }
//
//        if (Math.abs(x - y) == b) {
//            return new KeyValue<>(x, y);
...
//        for (int x = a; x >= 0; x--) {
//            // Calculate y using the relationship y = 10 - x
//            int y = a - x;
//
//            if (Math.abs(x - y) == b) {
////                // Print the solution
////                return new KeyValue<>(x, y);
////            }
//// Ensure that a and b are of the same parity         // Check if the current values satisfy the equations
//
//        if (a <= 0 || b <= 0) {
