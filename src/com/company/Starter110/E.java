package com.company.Starter110;
...
public class E {
    public static void main(String[] args) {
        ...
        int[] primes = sieveEratosthenes(1000000+1);
...
//            int[] arr = readarr(sc, n);
    ...
    static boolean isPossible(int h, TreeSet<Integer> set) {
        boolean isContains = set.contains(h);
