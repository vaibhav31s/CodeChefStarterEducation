package com.company.Starter59.C;
...
class C {
   public static void main(String[] args) {
       ...
       while(t-- > 0){
               ...
               char[][]  prefix = new char[n][32];

               for(int  i = 0; i < n; i++){
                   for(int j = 0; j < 64; j++){
                       prefix[i] = Long.toBinaryString(arr[i]).toCharArray();
                   }
               }
...
//                   for(int  i = a; i <=b; i++){
//                       for(int j = c; j <=d; j++){
//                           int e = (int) (arr[i - 1] ^ arr[j - 1]);
//                           String s =Long.toBinaryString(e);
//                           out.println(s);
////                           if((s.length() - k )>= 0  && s.charAt(s.length() - k) == '1') ans++;
//                       }
//                   }
                   out.println( " " );
               }
