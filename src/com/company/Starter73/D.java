...
//            int[] arr = readarr(sc, n);
            ...
            while(true){
                ...
                if(b1 % a1 == 0 &&  b2 % a2 == 0){
                    out.println(max);
//                    String s3 = max.toString(2);
//                    out.println(a1.toString(2));
//                    out.println(a2.toString(2));
//                    out.println(max.toString(2));
//                    out.println(BigInteger.ZERO);
                    continue outer;
                }
