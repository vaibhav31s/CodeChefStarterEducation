...
public class B {
    static  HashSet<BigInteger> set = new HashSet<>();
...
//                    for (int j = 0; j <= 32; j++) {
//                        for (int k = 0; k <= 32; k++) {
//                          long a = (long) (Math.pow(2, i) + Math.pow(2, j) + Math.pow(2, k));
//                          set.add(new BigInteger(String.valueOf(a)));
//                        }
//                    }
//                }
////                out.println(set);
...
//            out.println(Long.parseLong(s,2));
//            if( set.contains(a))  yes();
//            else no();
//            out.println(sum);
