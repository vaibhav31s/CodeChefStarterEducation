...
//            int[] arr = readarr(sc, n);
            ...
            BigInteger f1 = X.pow(4);
            BigInteger f2 = Y.pow(2);
            f2 = f2.multiply(BigInteger.valueOf(4));
            f1 = f1.add(f2);

            BigInteger f3  = X.pow(2).multiply(BigInteger.valueOf(4)).multiply(Y);
