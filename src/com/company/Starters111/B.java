package com.company.Starters111;
...
import static java.lang.System.out;
 ...
 class B {
    public static void main(String[] args) {
        ...
        int t = sc.nextInt();
//        String goal = "CODETOWN";
        boolean[] goals = {false, true, false, true, false, true, false, false};
        outer:
        while (t-- > 0) {
//            int n =sc.nextInt();
//            int[] arr = readarr(sc, n);
            ...
            for(int i= 0; i < goals.length; i++) {
                if(goals[i] && isVowel(s.charAt(i))) {

                } else if(!goals[i] && !isVowel(s.charAt(i))) {
