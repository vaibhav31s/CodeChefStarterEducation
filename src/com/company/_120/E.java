...
class E {
    ...
    public static void main(String[] args) {
        ...
        while(t-- > 0){
            ...
            var  map = countSubarraysWithSumK1(arr, 0);
...
//                    if(possible+1 < i) continue ;
    ...
    public static int countSubarraysWithSumK(int[] a, int K, HashMap < Integer, Integer > hash) {
        int n = a.length;
...
//        out.println(hash);
    ...
    public static HashMap < Integer, Integer >  countSubarraysWithSumK1(int[] a, int K) {
        int n = a.length;
        HashMap < Integer, Integer > hash = new HashMap < > ();
        int count = 0, sum = 0;
        for (int i = 0; i < n; i++) {
...
//        out.println(hash);
    ...
    public static void print(int[] arr) { int i =0;for (int x : arr) { if (i == 0) { i++; continue; } out.print((x + 1) + " "); } out.println(); } public static void print(long[] arr) {        for (long x : arr)            out.print(x + " ");        out.println();    }    public static void print(String[] arr) {        for (String x : arr)            out.print(x + " ");        out.println();    }
