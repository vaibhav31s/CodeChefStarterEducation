    ...
    //            Arrays.stream(sc.nextInts(m)).forEach(arr::add);
    //            ArrayList<Integer> boxes[] = new ArrayList[n+1];
    //            for(int i = 0 ; i <= n ; i++) boxes[i] = new ArrayList<>();
